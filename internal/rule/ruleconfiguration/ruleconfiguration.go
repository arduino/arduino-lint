...
var configurations = []Type{
	...
	},
	{
		...
		Subcategory:      "boards.txt",
		ID:               "PF013",
		Brief:            "board option < min length",
		Description:      "",
		MessageTemplate:  "Custom board option value for board ID(s) {{.}} is less than the minimum length. See: https://arduino.github.io/arduino-cli/latest/platform-specification/#custom-board-options",
		DisableModes:     nil,
		EnableModes:      []rulemode.Type{rulemode.Default},
		InfoModes:        nil,
		WarningModes:     nil,
		ErrorModes:       []rulemode.Type{rulemode.Default},
		RuleFunction:     rulefunction.BoardsTxtBoardIDMenuMenuIDOptionIDLTMinLength,
	},
	{
		ProjectType:      projecttype.Platform,
		SuperprojectType: projecttype.All,
