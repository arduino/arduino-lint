...
var _arduinoLibraryPropertiesDefinitionsSchemaJson = []byte(`{
  ...
  "$id": "https://raw.githubusercontent.com/arduino/arduino-check/main/etc/schema/arduino-library-properties-definitions-schema.json",
...
var _arduinoLibraryPropertiesPermissiveSchemaJson = []byte(`{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://raw.githubusercontent.com/arduino/arduino-check/main/etc/schema/arduino-library-properties-permissive-schema.json",
...
var _arduinoLibraryPropertiesStrictSchemaJson = []byte(`{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://raw.githubusercontent.com/arduino/arduino-check/main/etc/schema/arduino-library-properties-strict-schema.json",
...
var _generalDefinitionsSchemaJson = []byte(`{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "$id": "https://raw.githubusercontent.com/arduino/arduino-check/main/etc/schema/general-definitions-schema.json",
